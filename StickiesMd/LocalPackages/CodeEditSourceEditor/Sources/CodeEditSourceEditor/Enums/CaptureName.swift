...
public enum CaptureName: Int8, CaseIterable, Sendable {
    ...
    public static func fromString(_ string: String?) -> CaptureName? { // swiftlint:disable:this cyclomatic_complexity
        ...
        case "markup.heading.1", "heading.1", "markup.heading.1.marker", "text.title":
            return .heading1
        case "markup.heading.2", "heading.2", "markup.heading.2.marker":
            return .heading2
        case "markup.heading.3", "heading.3", "markup.heading.3.marker":
            return .heading3
        case "markup.heading.4", "heading.4", "markup.heading.4.marker":
            return .heading4
        case "markup.heading.5", "heading.5", "markup.heading.5.marker":
            return .heading5
        case "markup.heading.6", "heading.6", "markup.heading.6.marker":
            return .heading6
        default:
            return nil
        }
